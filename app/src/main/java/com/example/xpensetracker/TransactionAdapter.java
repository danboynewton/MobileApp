...
import static com.example.xpensetracker.MainActivity.calculateBalance;
import static com.example.xpensetracker.MainActivity.checkIfEmpty;
import static com.example.xpensetracker.MainActivity.setBalance;
...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.TViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TransactionAdapter.TViewHolder holder, int position) {
        ...
        holder.tvDescription.setText(transactionList.get(holder.getAdapterPosition()).getDescription());
