    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    etAmount.setError("Enter Amount in Dollars.");
                    return;
                }
                ...
                try {
                    ...
                    sendTransaction(amt,etDescription.getText().toString().trim(),positive);
                    checkIfEmpty(transactionList.size());
                    ...
                    etAmount.setError("Please enter an amount greater than zero.");
                }
            }
        });
    }
